...
namespace MyRewards.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            //{
            //    customer = _repo.FindNopCommerceUser(model.Email, model.Password);

            //    if (customer != null && customer.Roles.Contains("Administrators"))
            //    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    string[] selectedRoles = { "User" };
                    var resultRole = await UserManager.AddToRolesAsync(user.Id, selectedRoles);
